            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    ...
                    <div className="sm:w-1/2 mb-10 px-4">
                        ...
                        <img alt="content" className="object-cover object-center h-full w-full" src="/public/Youtube.ico"/>
                        </div>
                        <h2 className="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">YouTube C hannel</h2>
                    ...
                    <div className="sm:w-1/2 mb-10 px-4">
                        ...
                        <p className="leading-relaxed text-base">I track my daily build up throught GitHub. Have a peak.</p>
                        <button className="flex mx-auto mt-6 text-white bg-yellow-500 border-0 py-2 px-5 focus:outline-none hover:bg-yellow-600 rounded">Button</button>
                    </div>
                    </div>
                </div>
