...
function Contact() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Whatever Theme, React, WordPress, We can get it done. Get you dream Theme execute with us. We are the generation.</p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a className="text-indigo-500">codewithjyoti@gmail.com</a>
          <p className="leading-normal my-5">India</p>
